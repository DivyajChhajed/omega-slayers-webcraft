...
const QuoteSection = ({ quote, author, position, darkBackground = true }: QuoteSectionProps) => {
  return (
    <section className={`py-20 relative overflow-hidden ${darkBackground ? 'bg-omega-black' : 'bg-gradient-to-r from-[#0f2027] via-[#203a43] to-[#2c5364]'}`}>
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        >
          <svg className="w-12 h-12 mx-auto mb-8 text-omega-red/80" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-8 leading-tight italic">
            "{quote}"
          </h2>
          
          <div className="flex flex-col items-center">
            <p className="text-xl text-omega-red font-semibold">{author}</p>
